  ...
  for (const item of ready) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        item.response = data;
        sent++;
        addDispatchLogV30(`Enviado: ${item.nome} · ${chip.name}`);
...
const PANELS = ['chips','inicio','importar','validacao','atribuicao','instagram','fila-zap','kanban','followups','acompanhamento','redirecionamentos','configuracoes'];
