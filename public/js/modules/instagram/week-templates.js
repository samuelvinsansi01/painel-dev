...
function saveInstaTemplates(t) {
  ...
  uiSyncLog('optimistic-update', { entity:'template', action:'save-instagram-cache', count:Array.isArray(t) ? t.length : 0 });
  scheduleOperationalSync({ delay:400, reason:'instagram-template-update' });
}
